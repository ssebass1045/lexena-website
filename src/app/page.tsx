...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-lexena-blanco">
              ...
              <div className="text-center lg:text-left" data-aos="fade-right">
                ...
                >
                  ...
                  <p className="text-lg md:text-xl mb-8 leading-relaxed max-w-2xl [text-shadow:_0_1px_2px_rgb(0_0_0_/_30%)]">
                    ...
                    <span className="text-lexena-naranja font-semibold [text-shadow:_0_1px_1px_rgb(0_0_0_/_20%)]">
                      derecho minero ambiental
                    </span>
                    ,
                    <span className="text-lexena-verde font-semibold [text-shadow:_0_1px_1px_rgb(0_0_0_/_20%)]">
                      {" "}
                      legislación aduanera
                    </span>{" "}
                    e
                    <span className="text-lexena-blanco font-semibold [text-shadow:_0_1px_1px_rgb(0_0_0_/_20%)]">
                      {" "}
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                    <div className="text-center">
                      <div className="bg-gradient-to-br from-lexena-naranja/20 to-lexena-verde/20 rounded-2xl p-4 border border-white/10 backdrop-blur-sm">
                        <div className="text-3xl font-bold text-lexena-naranja mb-1 [text-shadow:_0_1px_2px_rgb(0_0_0_/_50%)]">
                          7+
                        </div>
                        <div className="text-sm text-lexena-blanco [text-shadow:_0_1px_1px_rgb(0_0_0_/_60%)]">
                          Años de Experiencia
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <motion.a
                      ...
                      onClick={() =>
                        handleConsultationClick("Hero Section", "General")
                      }
                  ...
                  <div className="w-64 h-64 bg-gradient-to-br from-lexena-naranja/20 to-lexena-verde/20 rounded-full flex items-center justify-center border border-white/10 backdrop-blur-sm">
                    <div className="w-64 h-64 bg-gradient-to-br from-lexena-azul to-lexena-azul-dark rounded-full flex items-center justify-center border border-white/20">
                      <div className="text-center">
                        ...
                        <div className="text-lexena-blanco font-bold text-lg">
                          Confianza
                        </div>
                        <div className="text-lexena-gris text-sm">
                          y Profesionalismo
                        </div>
                      </div>
                    </div>
      ...
      <section
        id="servicios"
        className="py-20 bg-gradient-to-br from-gray-50 to-lexena-blanco"
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Soluciones legales integrales adaptadas a las necesidades
              específicas de su empresa o persona.
            </p>
          </div>
          ...
          <div className="mb-12" data-aos="fade-up">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-green-500 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-lexena-azul">
                  Insolvencia: Reorganización - Liquidación
                </h3>
              </div>
              <p className="text-gray-700 mb-6 text-lg">
                Soluciones legales para empresas en crisis financiera y procesos
                de reorganización
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Gestión de procesos de insolvencia bajo supervisión de
                ...
                <div className="bg-green-50 rounded-lg p-4">
                  <h4 className="font-semibold text-green-800 mb-3">
                    ...
                    comerciante (Ley 2445){" "}
                  </h4>
                  <p className="text-sm text-gray-600 mb-3">
                    Asesoría legal para personas naturales y pequeños
                    comerciantes
                  </p>
                  <ul className="text-sm text-gray-500 space-y-2">
                    <li className="flex items-center">
          ...
          <div className="mb-12" data-aos="fade-up" data-aos-delay="100">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-blue-500 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 mb-6 text-lg">
                Soluciones integrales para operaciones de comercio exterior y
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Gestión legal especializada en operaciones de importación y
                    exportación
                  </p>
                  <ul className="text-sm text-gray-500 space-y-2">
                    <li className="flex items-center">
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-500 rounded-full mr-2"></span>
                      Representación en Procesos y Respuesta a Requerimientos
                      Aduaneros
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Canalización y gestión de inversiones extranjeras en
                    Colombia
                  </p>
                  <ul className="text-sm text-gray-500 space-y-2">
                    <li className="flex items-center">
          ...
          <div className="mb-12" data-aos="fade-up" data-aos-delay="200">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-orange-500 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-lexena-azul">
                  Derecho Minero Ambiental e Inmobiliario y Desarrollo Urbano
                </h3>
              </div>
              <p className="text-gray-700 mb-6 text-lg">
                Asesoría integral en proyectos mineros y ambientales, como
                también en el derecho inmobiliario y el desarrollo urbano con
                enfoque en sostenibilidad y cumplimiento normativo.
              </p>

              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-orange-50 rounded-lg p-4">
                  <h4 className="font-semibold text-orange-800 mb-3">
                    Derecho minero ambienta{" "}
                  </h4>
                  <p className="text-sm text-gray-600 mb-3">
                    Gestión integral de trámites y permisos ambientales para
                ...
                <div className="bg-orange-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-500 space-y-2">
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-orange-500 rounded-full mr-2"></span>
                      Urbanos, rurales, obras de infraestructura, construcciones
                      especiales, semovientes, servidumbres, intangibles, daño
                      emergente lucro cesante, recursos naturales y suelos de
                      protección, edificaciones de conservación arqueológica y
                      monumentos históricos, maquinaria y equipos especiales,
                      activos, operacionales y establecimientos de comercio
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-orange-500 rounded-full mr-2"></span>
                      Revisión y contestación de avalúos como prueba pericial
                      ante el juez
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-orange-50 rounded-lg p-4">
                  <h4 className="font-semibold text-orange-800 mb-3">
                    Derecho Inmobiliario y desarrollo urbano
                  </h4>
                  <p className="text-sm text-gray-600 mb-3">
                    Servicios legales especializados en desarrollo urbano y
                    propiedad
                  </p>
                  <ul className="text-sm text-gray-500 space-y-2">
                    <li className="flex items-center">
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-orange-500 rounded-full mr-2"></span>
                      licencias de construcción, parcelación, subdivisión |
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-orange-500 rounded-full mr-2"></span>
                      Código Nacional de Seguridad y Convivencia Ciudadana ley
                      1801 de 2016
                    </li>
                  </ul>
                </div>
          ...
          <div className="text-center mt-12" data-aos="fade-up">
            <div className="bg-gradient-to-r from-lexena-azul to-blue-800 rounded-2xl p-8 text-lexena-blanco">
              ...
              <p className="text-lg mb-6 max-w-2xl mx-auto">
                Nuestro equipo multidisciplinario está listo para brindarle
      ...
      <section
        id="ena"
        className="py-20 bg-gradient-to-br from-gray-900 to-lexena-azul text-lexena-blanco"
      >
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Contenido de Texto */}
            <div data-aos="fade-right">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Presentamos a <span className="text-lexena-naranja">ENA</span>:
                Inteligencia Artificial al servicio de tu tranquilidad legal.
              </h2>
              <p className="text-lg md:text-xl mb-8 leading-relaxed text-gray-300">
                Tu asistente jurídico disponible 24/7. ENA agiliza la consulta
                inicial, analiza documentos preliminares y te conecta con el
                especialista adecuado al instante.
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  ...
                  <span className="text-lg">
                    Respuestas inmediatas a consultas legales básicas
                  </span>
                </div>
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-lexena-naranja rounded-full flex items-center justify-center mr-3">
                  ...
                  <span className="text-lg">
                    Análisis preliminar de documentos legales
                  </span>
                </div>
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-lexena-naranja rounded-full flex items-center justify-center mr-3">
                  ...
                  <span className="text-lg">
                    Conexión directa con abogados especializados
                  </span>
                </div>
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-lexena-naranja rounded-full flex items-center justify-center mr-3">
            ...
            <div className="relative" data-aos="fade-left">
              <div className="bg-gradient-to-br from-lexena-naranja/20 to-lexena-azul/20 rounded-2xl p-8 border border-white/10 backdrop-blur-sm">
                ...
                <div className="text-center mt-6">
                  <h3 className="text-2xl font-bold text-lexena-naranja mb-2">
                    ENA
                  </h3>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Nuestra firma se especializa en brindar soluciones legales
              integrales con enfoque estratégico y resultados medibles para cada
              área de práctica
            </p>
          </div>
          ...
          <div className="mb-12" data-aos="fade-up">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-blue-500 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 mb-4 text-lg">
                <strong>Objetivo:</strong> Acompañar a las empresas que
                atraviesan crisis de liquidez para que entren de forma segura y
                estratégica a un proceso de insolvencia empresarial.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Lograr acuerdos de pago que permitan la continuidad del
                    negocio y el mantenimiento de los empleos.
                  </p>
                </div>
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Adelantar una liquidación organizada y eficiente ante la
                    Superintendencia de Sociedades, reduciendo al máximo los
                    riesgos personales.
                  </p>
                </div>
              </div>
          ...
          <div className="mb-12" data-aos="fade-up" data-aos-delay="100">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-green-500 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-lexena-azul">
                  Recuperación de la Persona Natural Sobreendeudada
                </h3>
              </div>
              <p className="text-gray-700 mb-4 text-lg">
                <strong>Objetivo:</strong> Guiar a personas naturales y pequeños
                comerciantes que ya no pueden pagar sus deudas para que accedan
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Detener la presión de cobros y embargos dentro del marco
                    legal mediante el Centro de Conciliación APG+1.
                  </p>
                </div>
                <div className="bg-green-50 rounded-lg p-4">
                  <h4 className="font-semibold text-green-800 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Negociar acuerdos de pago realistas adaptados a la capacidad
                ...
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Reordenar la vida financiera y jurídica para volver a
                    empezar sin cargar eternamente con la misma deuda.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-12" data-aos="fade-up" data-aos-delay="200">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-emerald-500 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-lexena-azul">
                  Regularización Ambiental Agroindustrial
                </h3>
              </div>
              <p className="text-gray-700 mb-4 text-lg">
                <strong>Objetivo:</strong> Acompañar a fincas, plantas de
                beneficio, centros de acopio y proyectos agroindustriales en la
                obtención y regularización de licencias.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-emerald-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Obtención y regularización de licencias y permisos
                    ambientales para operaciones legales.
                  </p>
                </div>
                <div className="bg-emerald-50 rounded-lg p-4">
                  <h4 className="font-semibold text-emerald-800 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Atención a requerimientos de autoridades ambientales para
          ...
          <div className="mb-12" data-aos="fade-up" data-aos-delay="300">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-purple-500 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-lexena-azul">
                  Optimización Aduanera y de Comercio Exterior
                </h3>
              </div>
              <p className="text-gray-700 mb-4 text-lg">
                <strong>Objetivo:</strong> Apoyar a empresas exportadoras e
                importadoras del Urabá en estrategias legales aduaneras y
                tributarias.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-purple-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Diseñar estrategias legales aduaneras y tributarias
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Reducir costos innecesarios por errores en la operación,
                    sanciones o mala planificación.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-12" data-aos="fade-up" data-aos-delay="400">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-red-500 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 mb-4 text-lg">
                <strong>Objetivo:</strong> Prevenir contingencias penales y
                reputacionales en la empresa mediante un enfoque integral de
                cumplimiento, control interno y gobierno corporativo, reduciendo
                el riesgo de investigaciones y sanciones.
              </p>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-red-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Identificar focos de riesgo (tributario, cambiario,
                    contratación, proveedores, fraude interno, corrupción,
                    reportes) y diseñar controles, políticas y responsables para
                    mitigarlos.
                  </p>
                </div>
                <div className="bg-red-50 rounded-lg p-4">
                  <h4 className="font-semibold text-red-800 mb-2">
                    Cumplimiento y Evidencia de Buena Fe
                  </h4>
                  <p className="text-sm text-gray-600">
                    Implementar protocolos, capacitaciones y trazabilidad
                    documental para demostrar diligencia debida, prevenir fallas
                    y fortalecer la posición de la empresa ante auditorías o
                    requerimientos.
                  </p>
                </div>
                <div className="bg-red-50 rounded-lg p-4">
                  <h4 className="font-semibold text-red-800 mb-2">
                    Continuidad del Negocio y Respuesta Temprana
                  </h4>
                  <p className="text-sm text-gray-600">
                    Crear rutas de actuación ante alertas (requerimientos,
                    hallazgos, denuncias internas) con investigaciones internas
                    básicas, planes correctivos y acompañamiento estratégico
                    para contener el riesgo antes de que escale.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-12" data-aos="fade-up" data-aos-delay="500">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-amber-500 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-lexena-azul">
                  Regularización y Estructuración Inmobiliaria
                </h3>
              </div>
              <p className="text-gray-700 mb-4 text-lg">
                <strong>Objetivo:</strong> acompañar jurídicamente tanto a
                personas naturales y jurídicas en el desarrollo inmobiliario,
                ofreciendo certeza sobre el debido cumplimientos de las normas
                vigentes de los planes de ordenamiento con todas sus
                determinantes.
              </p>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-amber-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Limpieza jurídica y regularización de títulos de propiedad
                    para garantizar seguridad legal.
                  </p>
                </div>
                <div className="bg-amber-50 rounded-lg p-4">
                  <h4 className="font-semibold text-amber-800 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Solución de conflictos de tenencia y linderos mediante
                ...
                <div className="bg-amber-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Estructuración legal de proyectos de vivienda, comercio o
                    industria para viabilidad jurídica.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-12" data-aos="fade-up" data-aos-delay="600">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-teal-500 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-lexena-azul">
                  Protección Ambiental Comunitaria
                </h3>
              </div>
              <p className="text-gray-700 mb-4 text-lg">
                <strong>Objetivo:</strong> Asesorar y representar a comunidades,
                juntas de acción comunal y colectivos ciudadanos en casos de
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-teal-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Casos de afectación ambiental por actividades mineras,
                ...
                <div className="bg-teal-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Acciones populares, tutelas, medidas cautelares y otros
              ...
              <div className="mt-4 bg-teal-50 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600">
                  Buscar medidas de compensación, restauración y protección real
                  del ecosistema local, sin desconocer la importancia del
          ...
          <div className="text-center mt-12" data-aos="fade-up">
            <div className="bg-gradient-to-r from-lexena-azul to-blue-800 rounded-2xl p-8 text-lexena-blanco">
              <h3 className="text-2xl font-bold mb-4">
                ¿Necesita asesoría en alguno de estos servicios especializados?
              </h3>
              <p className="text-lg mb-6 max-w-2xl mx-auto">
                Nuestro equipo de abogados especializados está listo para
                brindarle soluciones legales efectivas y personalizadas para
                cada uno de estos alcances y objetivos
              </p>
              <a
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Profesionales multidisciplinarios con amplia experiencia en el
              sector legal
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Abogado 1 */}
            <div
              className="bg-white rounded-lg shadow-lg overflow-hidden hover:scale-105 hover:shadow-2xl transition-all duration-300"
              data-aos="fade-up"
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-lexena-azul mb-2">
                  Néstor Ramírez - Abogado & Contador
                </h3>
                <p className="text-gray-600 mb-4">
                  Especialista en legislación aduanera, asesorías contables y
                  tributarias.
                </p>
                <div className="text-sm text-gray-500">
                  <p>
                    <strong>Pregrados:</strong> Contador, Abogado
                  </p>
                  <p>
                    <strong>Posgrados:</strong> Legislación aduanera
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-lexena-azul mb-2">
                  Alveiro Camelo - Abogado & Constructor Civil
                </h3>
                <p className="text-gray-600 mb-4">
                  Experto en derecho minero ambiental, inmobiliario y desarrollo
                  urbano.
                </p>
                <div className="text-sm text-gray-500">
                  <p>
                    <strong>Pregrados:</strong> Construcciones Civiles, Abogado
                  </p>
                  <p>
                    <strong>Posgrados:</strong> Legislación minera y ambiental
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-lexena-azul mb-2">
                  Edwin Arcila - Abogado & Economista
                </h3>
                <p className="text-gray-600 mb-4">
                  Especialista en gestión tributaria, delitos económicos e
                  insolvencia empresarial.
                </p>
                <div className="text-sm text-gray-500">
                  <p>
                    <strong>Pregrados:</strong> Economista, Abogado
                  </p>
                  <p>
                    <strong>Posgrados:</strong> Gestión tributaria
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg shadow-lg overflow-hidden border-2 border-lexena-naranja/30 hover:scale-105 hover:shadow-2xl transition-all duration-300"
              data-aos="fade-up"
              data-aos-delay="300"
            >
              <div className="h-48 relative">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-lexena-naranja mb-2">
                  ENA - Asistente Jurídico Virtual
                </h3>
                <p className="text-gray-300 mb-4">
                  Inteligencia Artificial especializada en consultas legales
                  iniciales, análisis de documentos y conexión con abogados
                  especializados.
                </p>
                <div className="text-sm text-gray-400">
                  <p>
                    <strong>Disponibilidad:</strong> 24 horas, 7 días a la
                    semana
                  </p>
                  <p>
                    <strong>Especialidad:</strong> Consultas iniciales y
                    análisis preliminar
                  </p>
                  <p>
                    <strong>Tecnología:</strong> IA avanzada con aprendizaje
                    continuo
                  </p>
                </div>
                <div className="mt-4 pt-4 border-t border-gray-700">
                  <div className="flex items-center">
                    ...
                    <span className="text-xs text-gray-400">
                      Borde brillante identificativo
                    </span>
                  </div>
                </div>
              </div>
