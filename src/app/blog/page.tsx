        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-lexena-gris max-w-2xl mx-auto">
              Información actualizada y consejos legales especializados para empresas y personas de la región de Urabá
            </p>
          </div>
        </div>
      </header>
            ...
            {blogPosts.map((post) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h2 className="text-xl font-bold text-lexena-azul mb-3 line-clamp-2">
                    {post.titulo}
                  </h2>
